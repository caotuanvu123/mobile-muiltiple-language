        ...
        <div class="login-main">
            ...
            <div class="login-block">
                ...
                <form action="{{url('login')}}" method="post" role="form">
                    ...
                    <h3>{{trans('messages.not_member')}}<a href="signup.html">{{trans('messages.register_lable')}}</a></h3>
                    <h2>{{trans('messages.or_login')}}</h2>
                    <div class="login-icons">
                        <ul>
                            <li><a href="{{ route('auth.name') }}" class="facebook"><i class="fa fa-facebook"></i></a></li>
                        </ul>
                    </div>
                </form>
